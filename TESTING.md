...
- projected entity types and affordances remain within registration-time capability envelopes
- currently unavailable commands are rejected before owner mutation
